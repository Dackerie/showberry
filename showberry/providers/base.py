...
def get_all_providers():
    ...
    from showberry.providers.vidzee import VidZeeProvider
    from showberry.providers.cinesrc import CineSrcProvider
    from showberry.providers.superembed import SuperEmbedProvider
